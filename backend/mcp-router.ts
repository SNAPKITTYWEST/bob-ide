...
export async function routeToMCP(call: MCPCall): Promise<any> {
...
async function inferenceWithFallback(args: any): Promise<any> {
...
async function evalClojure(args: any): Promise<any> {
...
async function verifyProof(args: any): Promise<any> {
