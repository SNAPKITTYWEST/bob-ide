...
// =====================================================================
export async function compileNaturalLanguageToXML(req) {
...
async function compileWithGBNF(req) {
    ...
    try {
        // Read GBNF grammar
        const grammarPath = path.join(__dirname, '../artifacts/bridges/xml-compiler-grammars/sovereign_prompt.gbnf');
...
async function compileWithSkeleton(req) {
    ...
    try {
        ...
        const skeletonPath = path.join(__dirname, '../artifacts/bridges/xml-compiler-skeletons/sovereign_prompt.xml');
...
export async function controlModelViaXML(req) {
    const startTime = Date.now();
